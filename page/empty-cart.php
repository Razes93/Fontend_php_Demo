...
<!-- Mirrored from spacingtech.com/html/vegist-final/vegist-box/empty-cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Apr 2022 02:40:19 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="col">
                    <div class="empty-start">
                        <h2 class="empty-title">
                            <span>Your</span>
                            <span class="color-text">cart</span><br>
                            <span>is currently</span>
                            <span class="color-text">empty!</span>
                        </h2>
                        <span class="empty-more">Continue browsing <a href="grid-list.php">here</a></span>
                    </div>
                </div>
            </div>
        </div>
