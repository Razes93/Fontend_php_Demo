...
<!-- Mirrored from spacingtech.com/html/vegist-final/vegist-box/account.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Apr 2022 02:38:02 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="col">
                    ...
                    <div class="account-area">
                        <div class="account">
                            <h4>My account</h4>
                            <ul class="page-name">
                                <li class="register-id"><a href="wishlist.php">Wishlist(0)</a></li>                                
                                <li class="register-id"><a href="login.php">Logout</a></li>
                            </ul>
                        </div>
